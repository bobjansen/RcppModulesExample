...
but only at a basic level. I'm not a C++ expert either (I did get expert advice
though). Stubbornness might help. The code does not include any functionality
except for concatenating, printing and multiplying strings by design. The only
goal of the package is to give minimal examples of all Rcpp Modules features.
The package around this vignette is fully functional and should be loadable
